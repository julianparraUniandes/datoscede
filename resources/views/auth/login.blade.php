@extends('layouts.main', ['title' =>  __('Login') ])
...
<div class="container">
    <form class="tipo-crimson mb-5" method="POST" action="{{ route('login') }}">
        @csrf
        ...
        <div class="form-group row mb-0">
            <div class="col-md-8 offset-md-4">
                <button type="submit" class="btn btn-primary bg-light text-dark border-dark">
                    {{ __('Login') }}
                </button>
