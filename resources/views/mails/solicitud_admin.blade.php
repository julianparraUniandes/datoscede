            ...
            <td>
                <center>
                    <p style="font-family: 'Times New Roman', Times, serif; margin: 0px 45px; font-size: 14px; font-weight: 200; color: #6d6d6d;">
                        ...
                        El/La usuario  {{$name}} {{$surname}} está solicitando acceso a la siguiente base de datos {{$nombre_metadata}} Para acceder a dicha información es necesario contar con su autorización avalando que dicha informaciónesta  va ser usada con fines académicos en la investigación o materia que usted dirige o imparte. 
                        El/La usuario especifica que la información va ser usada en el marco del siguiente proyecto:<br><br>
                        {{$descripcion}}
                        <br><br>
                        Si usted da el visto bueno a esta solicitud por favor notifíquelo haciendo clic en el siguiente link: <br><br>
                        <a href="{{env('APP_URL')}}/urlfactive_bd.php?frgtysa={{$uuid}}&xza={{$user_id}}">activar</a>
                        <br><br>                      
                        

                        En el caso contrario haga clic en el siguiente link para no activar la descarga de la base de datos: <br><br>
                        <a href="{{env('APP_URL')}}/urlfdesactive_bd.php?frgtysa={{$uuid}}&xza={{$user_id}}">desactivar</a>
                        <br><br>       
