            ...
            <td>
                <center>
                    <p style="font-family: 'Times New Roman', Times, serif; margin: 0px 45px; font-size: 14px; font-weight: 200; color: #6d6d6d;">
                        ...
                        Su solicitud ha sido recibida y registrada.<br>
                        En el transcurso de los próximos tres (3) días hábiles usted tendrá alguna respuesta. <br>
                        El administrador del sitio evaluará su solicitud y será quien dará el visto bueno y aprobación para que pueda hacer uso de la base de datos. Cualquier inconsistencia o falta de claridad en la solicitud presentada, será razón suficiente para rechazarla. 
                        <br>
                        ...
                        <br><br>
                        Cualquier inquietud por favor hágamela saber.<br>
